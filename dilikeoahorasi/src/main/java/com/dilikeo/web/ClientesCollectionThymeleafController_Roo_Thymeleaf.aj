...
import com.dilikeo.web.ClientesCollectionThymeleafController;
import com.dilikeo.web.ClientesItemThymeleafController;
import com.dilikeo.web.ClientesItemThymeleafLinkFactory;
...
privileged aspect ClientesCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void ClientesCollectionThymeleafController.populateFormats(Model model) {
        ...
        model.addAttribute("fecha_de_registro_en_sistema_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
    ...
    public void ClientesCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_cliente_telefono", null, "Telefono", locale), "telefono", Long.class.getName(), 100);
        }
        ...
        else if (columnName.equals("fecha_de_registro_en_sistema")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_fecha_de_registro_en_sistema", null, "Fecha _ De _ Registro _ En _ Sistema", locale), "fecha_de_registro_en_sistema", Date.class.getName(), 100);
        }
        else if (columnName.equals("correo")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_correo", null, "Correo", locale), "correo", String.class.getName(), 100);
        }
        }
